...
<head>
  ...
  <title>Edit Penitipan - KosinAja</title>
...
<body>
  ...
  <div class="main-content">
    ...
    <form action="{{ route('admin.update_penitipan', $data->id) }}" method="POST">
      @csrf
      @method('PUT')
      ...
      <div class="form-group">
        ...
        <input type="number" name="jumlah_barang" value="{{ old('jumlah_barang', $data->jumlah_barang) }}" required>
      </div>

      <div class="form-group">
        <label>Tanggal Awal</label>
        <input type="date" name="tanggal_awal" value="{{ old('tanggal_awal', $data->tanggal_awal) }}" required>
      </div>
      ...
      <a href="{{ route('admin.penitipan') }}" class="btn btn-secondary">Batal</a>
    </form>
  </div>
